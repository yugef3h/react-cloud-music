<template>
  <div class="mdContainer" :class="{ fullPage: fullPageStatus }">
    <div class="navContainer" v-if="navStatus">
      标题：
      <div>
        <input class="mytitle" type="text" v-model="title"><br>
      </div>
...
<script>
  ...
  import hljs from '../../../static/md/js/highlight.min.js'
  import range from '../../../static/md/js/rangeFn.js'
  Vue.use(scroll)
  marked.setOptions({
...
<style lang="scss">
  ...
  @import "../../../static/md/css/github-markdown.css";
  /*引入atom的代码高亮样式文件*/
  @import "../../../static/md/css/atom-one-dark.min.css";
  .mdContainer {
    width: 100%;
    height: 100%;
